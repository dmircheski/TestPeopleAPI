...
public class ConversionUtils {
    ...
    public static String convertDateString(String createdDatetime) {
        String createdDate = createdDatetime.substring(0, 10) + "T";
        String createdTime = createdDatetime.substring(11) + "Z";
